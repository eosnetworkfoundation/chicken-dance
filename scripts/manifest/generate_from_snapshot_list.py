...
if __name__ == '__main__':
    ...
    start_block_num = 0
    snapshot_file_name = "snapshot-2018-06-10-01-eos-v6-0000000000.bin.zst"
    ...
    with open('snapshots.txt', 'r') as file:
        ...
        for line in lines:
            ...
            if parts[0] != "snapshot" or parts[5] != "eos" or parts[6] != "v6":
            ...
            record = {
                ...
                "snapshot_path": "s3://chicken-dance/mainnet/snapshots/"+snapshot_file_name,
                "storage_type": "s3",
                "expected_integrity_hash": "",
                "leap_version": "1.0.0-rc3"
                }
